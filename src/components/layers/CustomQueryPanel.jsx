...
const PROPERTY_CATEGORIES = [
  {
    id: "people", label: "People", color: "bg-amber-100 text-amber-800",
    targetLayer: "people",
    properties: [
  ...
  {
    id: "organisations", label: "Organisations", color: "bg-orange-100 text-orange-800",
    targetLayer: "organisations",
    properties: [
  ...
  {
    id: "livingEntities", label: "Living Entities", color: "bg-lime-100 text-lime-800",
    targetLayer: "livingEntities",
    properties: [
      { pid: "P181",  label: "taxon range map" },
      { pid: "P171",  label: "parent taxon" },
      { pid: "P105",  label: "taxon rank" },
      { pid: "P141",  label: "IUCN conservation status" },
      { pid: "P183",  label: "endemic to" },
      { pid: "P176",  label: "manufacturer (organism)" },
      { pid: "P571",  label: "inception (first observed)" },
      { pid: "P576",  label: "extinct since" },
      { pid: "P625",  label: "coordinate location" },
      { pid: "P279",  label: "subclass of" },
    ],
  },
  {
    id: "artificialAgents", label: "Artificial Agents", color: "bg-sky-100 text-sky-800",
    targetLayer: "artificialAgents",
    properties: [
      { pid: "P571",  label: "inception / first deployed" },
      { pid: "P576",  label: "decommissioned" },
      { pid: "P178",  label: "developer" },
      { pid: "P275",  label: "copyright license" },
      { pid: "P277",  label: "programming language" },
      { pid: "P31",   label: "instance of" },
      { pid: "P279",  label: "subclass of" },
      { pid: "P366",  label: "use / purpose" },
  ...
  {
    id: "phenomena", label: "Phenomena", color: "bg-yellow-100 text-yellow-800",
    targetLayer: "phenomena",
    properties: [
      { pid: "P585",  label: "point in time" },
      { pid: "P580",  label: "start time" },
      { pid: "P582",  label: "end time" },
      ...
      { pid: "P625",  label: "coordinate location" },
      { pid: "P17",   label: "country" },
      { pid: "P1120", label: "number of deaths" },
      { pid: "P1542", label: "has effect" },
      { pid: "P828",  label: "has cause" },
      { pid: "P31",   label: "instance of" },
    ],
  },
  {
    id: "conflicts", label: "Conflicts", color: "bg-red-100 text-red-800",
    targetLayer: "conflicts",
    properties: [
      { pid: "P580",  label: "start time" },
      { pid: "P582",  label: "end time" },
      { pid: "P276",  label: "location" },
      { pid: "P710",  label: "participant" },
      { pid: "P1120", label: "number of deaths" },
      { pid: "P750",  label: "distributed by (result)" },
      { pid: "P1346", label: "winner" },
      { pid: "P1478", label: "has immediate cause" },
      { pid: "P1534", label: "end cause" },
      { pid: "P361",  label: "part of (larger conflict)" },
      { pid: "P527",  label: "has part (battles)" },
    ],
  },
  {
    id: "places", label: "Places", color: "bg-green-100 text-green-800",
    targetLayer: "places",
    properties: [
      { pid: "P625",  label: "coordinate location" },
      { pid: "P17",   label: "country" },
  ...
  {
    id: "objects", label: "Objects", color: "bg-stone-100 text-stone-800",
    targetLayer: "objects",
    properties: [
      { pid: "P571",  label: "inception / created" },
      { pid: "P186",  label: "material used" },
      { pid: "P170",  label: "creator" },
      { pid: "P276",  label: "location" },
      { pid: "P195",  label: "collection" },
      { pid: "P127",  label: "owned by" },
      { pid: "P1071", label: "location of final assembly" },
      { pid: "P366",  label: "use / purpose" },
      { pid: "P31",   label: "instance of" },
      { pid: "P279",  label: "subclass of" },
    ],
  ...
  {
    id: "technology", label: "Technology", color: "bg-indigo-100 text-indigo-800",
    targetLayer: "technology",
    properties: [
      { pid: "P571",  label: "inception / invented" },
      { pid: "P170",  label: "creator / inventor" },
      { pid: "P178",  label: "developer" },
      { pid: "P277",  label: "programming language" },
      { pid: "P275",  label: "copyright license" },
      { pid: "P366",  label: "use / purpose" },
  ...
  {
    id: "works", label: "Works", color: "bg-rose-100 text-rose-800",
    targetLayer: "works",
    properties: [
  ...
  {
    id: "concepts", label: "Concepts & Ideas", color: "bg-purple-100 text-purple-800",
    targetLayer: "concepts",
    properties: [
      { pid: "P571",  label: "inception / first recorded" },
      { pid: "P170",  label: "creator / founder" },
      { pid: "P495",  label: "country of origin" },
      { pid: "P361",  label: "part of" },
      { pid: "P527",  label: "has part" },
      { pid: "P279",  label: "subclass of" },
      { pid: "P31",   label: "instance of" },
      { pid: "P1269", label: "facet of" },
      { pid: "P138",  label: "named after" },
    ],
  },
  {
    id: "sciences", label: "Sciences", color: "bg-teal-100 text-teal-800",
    targetLayer: "sciences",
    properties: [
      { pid: "P571",  label: "inception / established" },
      { pid: "P170",  label: "founder" },
      { pid: "P361",  label: "part of (field)" },
      { pid: "P527",  label: "has part (subfields)" },
      { pid: "P279",  label: "subclass of" },
      { pid: "P31",   label: "instance of" },
      { pid: "P101",  label: "field of work" },
      { pid: "P495",  label: "country of origin" },
      { pid: "P138",  label: "named after" },
    ],
  },
  {
    id: "weather", label: "Weather", color: "bg-cyan-100 text-cyan-800",
    targetLayer: "weather",
    properties: [
      { pid: "P585",  label: "point in time" },
      { pid: "P276",  label: "location" },
